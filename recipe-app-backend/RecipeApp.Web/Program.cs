...
using RecipeApp.Web;
using RecipeApp.Web.Helpers;
using Swashbuckle.AspNetCore.SwaggerGen;
using AutoMapperProfile = RecipeApp.Web.Helpers.AutoMapperProfile;
...
builder.Services.AddAutoMapper(
    typeof(RecipeApp.Infrastructure.AutoMapperProfile),
    typeof(RecipeApp.Application.AutoMapperProfile),
