...
export default function Identity() {
    ...
    return !userContext.isAuthenticated() ? <LoggedOut /> :
        <LoggedIn context={userContext} setContext={setUserContext} />;
}

const LoggedIn = ({ context, setContext }: {
    context: UserContext,
    setContext: (userContext: UserContext) => void
}) => {
